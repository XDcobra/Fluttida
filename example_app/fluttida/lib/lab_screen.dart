    ...
    return Card(
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            SwitchListTile(
              title: const Text('SSL Pinning'),
              subtitle: const Text('Global toggle across Android stacks'),
              ...
              Row(
                children: [
                  ...
                  IconButton(
                    ...
                    onPressed: () {
                      final list = List<String>.from(activePins)..removeAt(i);
                      _savePinningConfig(
              ...
              children: [
                ...
                ElevatedButton(
                  onPressed: () async {
                    ...
                    if (imported != null) await _savePinningConfig(imported);
                  },
